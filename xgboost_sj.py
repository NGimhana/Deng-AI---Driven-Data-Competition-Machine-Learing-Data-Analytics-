...
dengi_test_x_data_file = os.path.join(dirname, 'x_y/four_month_before/original_data/test_x_sj_time_shifted.csv')
dengi_train_x_data_file = os.path.join(dirname, 'x_y/four_month_before/original_data/train_x_sj_time_shifted.csv')
dengi_test_y_data_file = os.path.join(dirname, 'x_y/four_month_before/original_data/test_y_sj.csv')
dengi_train_y_data_file = os.path.join(dirname, 'x_y/four_month_before/original_data/train_y_sj.csv')
...
submission_file = os.path.join(dirname, "x_y/four_month_before/submissions/sj_model_test.csv")
